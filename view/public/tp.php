<?php require_once $dir_public_requires.'header.php';?>
  <div class="main-content"> 
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="widget">
                  <div class="widget-content-white glossed">
                    <div class="padded">
                      <form action="#" role="form" class="form-horizontal">
                        <h3 class="form-title form-title-first"><i class="glyphicon glyphicon-book"></i>Official Details</h3>
                        <div class="form-group">
              ...
              <center><a href="teacher"><button class="btn btn-primary">Return Home</button></a></center>
            </div>
            </div>
