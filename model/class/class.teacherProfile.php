...
* Accessory
*/
class Tprofile extends DatabaseObject
{
	...
	protected static $db_fields = array('id', 'fname', 'lname', 'department_id', 'designation', 'qualification', 'email', 'contact','address', 'oroom', 'otelephone');
	...
	public static function find_department($type=0) {
		return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE department_id = '{$type}' ORDER BY id DESC");
	}
